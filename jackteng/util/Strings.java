...
public class Strings {
	...
	public static String getSubNGram(String ngram, int from, int to,
		...
		if ((from <= 0) || (to > Strings.getN(ngram, langType)) || (from > to)) {
			...
			if (langType == Strings.ChineseLike) {
				result = ngram.substring(from - 1, to);//String的一个返回子串的方法
			} else if (langType == Strings.EnglishLike) {
	...
	public static void main(String[] args) {
		System.out.println(Strings.isSucc("ㄓ代刚", "代刚", Strings.ChineseLike));
		System.out.println(Strings.isSucc(" This  is a book", "is a book",
																			Strings.EnglishLike));
		System.out.println(Strings.getN("中华人民共和国", Strings.ChineseLike));
		...
		System.out.println(Strings.inverse("ㄓ代刚  This  is   ,    a  book   "));
