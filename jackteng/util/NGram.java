...
public class NGram {
	...
	public static void main(String[] args) {
		/*
		System.out.println("" + (NGram.isChineseWord("") ? "琌" : "ぃ琌") + "いゅ!");
		byte[] b = new byte[2];
		b[0] = (byte) 161;
		b[1] = (byte) 65;
		...
		*/
		...
		NGram.NGramInfo info = ngram.getNGram("硂琌english term, one代刚!!!".toLowerCase(), true, true);
		...
		info = ngram.getNGram("硂琌enGlIsh Term, one代刚!!!".toLowerCase(), true, true);
		System.out.println("number of chinese term = " + info.chineseTermMap.size());
		System.out.println("number of english term = " + info.englishTermMap.size());

		info = ngram.getNGram("硂琌english term, one代刚!!!".toLowerCase(), true);
		System.out.println("number of chinese term = " + info.chineseTermMap.size());
		System.out.println("number of english term = " + info.englishTermMap.size());

		NGram.NGramInfo[] infos = ngram.get1ToNGrams("硂琌enGlIsh Term, one代刚!!!".
																								 toLowerCase(), true, true);
		infos = ngram.get1ToNGrams("硂琌enGlIsh Term, one代刚!!!".toLowerCase(), true, true);
		//System.out.println("number of chinese term = " + info.chineseTermMap.size());
		//System.out.println("number of english term = " + info.englishTermMap.size());
